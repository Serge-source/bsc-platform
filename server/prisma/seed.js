...
async function main() {
  ...
  const permDefs = [
    ...
    { resource: 'nav', action: 'ai', description: 'AI Assistant & Copilot' },
    { resource: 'nav', action: 'okrs', description: 'OKRs' },
    { resource: 'nav', action: 'portfolio', description: 'Portfolio / PPM' },
    { resource: 'nav', action: 'bpm', description: 'Business Processes' },
    { resource: 'nav', action: 'grc', description: 'Governance, Risk & Compliance' },
    { resource: 'nav', action: 'appraisals', description: 'Performance Appraisals' },
    { resource: 'nav', action: 'scenarios', description: 'Scenario Planning' },
    { resource: 'nav', action: 'bi', description: 'Business Intelligence' },
  ...
  await assignPerms(managerRole.id, [
    ...
    'nav:okrs', 'nav:portfolio', 'nav:bpm', 'nav:grc', 'nav:appraisals', 'nav:scenarios', 'nav:bi',
